...
@section('content')
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{asset('contents/website')}}/images/blog_single_background.jpg" data-speed="0.8" style="background-image:url({{asset('contents/website')}}/images/banner_background.jpg)"></div>
	</div>
				...
				<div class="col-lg-8 offset-lg-2">
					...
					<div class="single_post_text">
						...
						<div class="single_post_quote text-center">
							<div class="quote_image"><img src="{{asset('contents/website')}}/images/quote.png" alt=""></div>
